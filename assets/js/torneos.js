...
$(document).ready(async function() {  
  ...
  async function guarda_torneo(event) {
    ...
    async function elimina_torneo(event) {
      ...
      // Realiza la solicitud POST usando Axios
      return await axios.post('https://apis.dinossolutions.com/roni/torneos/' + alpha_id +'/delete',{id:alpha_id},{headers:header})
      .then(async function (response) {
          // Maneja la respuesta exitosa
...
var miTabla = $('#torneosTable').DataTable({
  ...
  initComplete: function () {
    ...
    miTabla.on('click', '.edit-item-btn', async function() {
      ...
      // Realiza la solicitud POST usando Axios
      return await axios.get('https://apis.dinossolutions.com/roni/torneos/'+id_alpha+'/id',{ headers: headers })
      .then(function (response) {
          // Maneja la respuesta exitosa
          //console.log(response.data);
          var datos =response.data;
