...
$(document).ready(function() {  
 ...
 //*************************************************************************************************************** */
  ...
  async function get_jugadores(){
    ...
    // Realiza la solicitud POST usando Axios
    return await axios.get('https://apis.dinossolutions.com/roni/jugadores_list/',{ headers: headers })
    .then(function (response) {
        // Maneja la respuesta exitosa
        console.log(response.status);
  ...
  var miTabla = $('#jugadoresTable').DataTable({
    ...
    initComplete: function () {
      ...
      miTabla.on('click', '.edit-item-btn', async function() {
        ...
        // Realiza la solicitud POST usando Axios
        return await axios.get('https://apis.dinossolutions.com/roni/jugadores/'+id_alpha+'/id',{ headers: headers })
        .then(async function (response) {
            // Maneja la respuesta exitosa
            //console.log(response.data);
            var datos =response.data;
