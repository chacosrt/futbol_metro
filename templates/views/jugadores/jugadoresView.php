                                ...
                                <div class="card-header">
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <div class="flex-grow-1">
                                            <button class="btn btn-info add-btn" data-bs-toggle="modal" data-bs-target="#showModal"><i class="ri-add-fill me-1 align-bottom"></i> Agregar Jugador</button>
                                        </div>
                                                        ...
                                                        <div class="row g-3">
                                                            <div class="col-lg-12">
                                                                <div class="text-center">
                                                                    ...
                                                                    <h5 class="fs-13 mt-3">Foto de Jugador</h5>
                                                                </div>                                                                
                                                            </div>
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <label for="app" class="form-label">Apelido Paterno</label>
