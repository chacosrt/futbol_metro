...
<body>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <img src="assets/images/logo.png" alt="" height="120" width ="120">                               
                                    <h5 class="text-primary">Bienvenido !</h5>
                                    <p class="text-muted">Secretaría del Deporte</p>
                                </div>
                                <div class="p-2 mt-4">
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">No tengo una cuenta <a href="auth-signup-basic.html" class="fw-semibold text-primary text-decoration-underline"> Registrarse </a> </p>
                        </div>
    ...
    <!-- JAVASCRIPT -->
    <?php require_once INCLUDES.'inc_footer_login.php'; ?>
