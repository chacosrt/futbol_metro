                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body p-5 text-center">
                                                    ...
                                                    <div class="mt-4 text-center">
                                                        <h4 class="fs-semibold">Deseas eliminar el equipo?</h4>
                                                        <p class="text-muted fs-14 mb-4 pt-1">El equipo se eliminara permanentemente de la base de datos</p>
                                                        <div class="hstack gap-2 justify-content-center remove">
                                                            ...
                                                            <input type="text" hidden id="idPartido">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
