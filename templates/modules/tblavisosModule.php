    ...
    <tbody>
        <?php if ($d->movements): ?>
            <?php foreach ($d->movements as $mov): ?>
                <tr>
                    <td><?php echo $mov->idAviso;?></td>
                    <td><?php echo $mov->titulo;?></td>
                    <td><?php echo $mov->mensaje;?></td>
                    <td><?php echo $mov->dirigido;?></td>
                    <td><?php echo $mov->tipo;?></td>
                    <td><?php echo $mov->fechaCrea;?></td>

                    <td>
                        <button class="btn btn-danger " type="button" data-unoo="<?php echo $mov->idAviso; ?>" data-toggle="modal" data-target="#eliminar"><i class="fa fa-trash"></i></button>
                    </td>
