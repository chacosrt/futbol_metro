        ...
        <?php if ($d->movements): ?>
            <?php foreach ($d->movements as $mov): ?>
              <tr>
                ...
                <td><button type="button" class="btn btn-block btn-danger" data-toggle="modal" data-unoo="<?php echo $mov->idDespido;?>" data-target="#elisalida"><i class='fa fa-trash'></i></button></td>
              </tr>
            <?php endforeach; ?>
        <?php else: ?>
