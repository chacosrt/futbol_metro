        ...
        <?php if ($d->movements): ?>
            <?php foreach ($d->movements as $mov): ?>
                <tr>
                    ...
                    <td><?php echo $mov->calificacion;?> de 5</td>
                    <td class='text-center'>
                       <button class="btn btn-success " type="button" data-unoo="<?php echo $mov->idSoporte; ?>" data-toggle="modal" data-target="#respuesta1"><i class="fa  fa-search"></i></button>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
