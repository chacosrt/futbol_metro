        ...
        <?php if ($d->movements): ?>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <?php 
                        if($mov->estatusper == NULL){
                            if($mov->estatus == 1){echo "Estudio solicitado";}
                            if($mov->estatus == 2){echo "Estudio asignado";}
                            if($mov->estatus == 3){echo "Estudio en proceso";}
                            if($mov->estatus == 4){echo "Estudio con visita programada";}
                            if($mov->estatus == 5){echo "Estudio con visita realizada";}
                        }else{ echo $mov->estatusper;}
                            
                        ?>
                    </td>
                    <td class="text-center">
                        <button class="btn btn-success " type="button" data-unoo="<?php echo $mov->idEstudio; ?>" data-toggle="modal" data-target="#archivos"><i class="fa fa-file"></i></button>
                        <!-- <a href='<?php echo CONTENEDOR."estudios/estudioNum_".$mov->idEstudio."/".$mov->archivo; ?>' style='cursor:pointer' target='_blank'><i class='fa fa-file'></i></a> -->
                    </td>
                    ...
                    <td>
                        ...
                        <!--button class="btn btn-danger " type="button" data-unoo="<?php echo $mov->idEstudio; ?>" data-toggle="modal" data-target="#eliminar"><i class="fa fa-times"></i></button-->
